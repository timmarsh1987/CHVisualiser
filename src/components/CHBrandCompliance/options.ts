import type { BrandComplianceOptions } from './types';
...
function normalizeOptionsRecord(
  record: Record<string, unknown>
): Partial<BrandComplianceOptions> {
  const normalized: Partial<BrandComplianceOptions> = {};
...
function mergeOptions(
  ...partials: Array<Partial<BrandComplianceOptions> | undefined>
): Partial<BrandComplianceOptions> {
  return partials.reduce<Partial<BrandComplianceOptions>>((merged, partial) => {
    if (!partial) {
      return merged;
    }
...
function parseOptionsInput(input: unknown): Partial<BrandComplianceOptions> | undefined {
  if (!input) {
    return undefined;
  }
...
): Partial<BrandComplianceOptions> | undefined {
